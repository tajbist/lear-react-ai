...
const ProductPage1: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-center text-base text-black font-inter">
      <div className="absolute w-[calc(100%_-_1045px)] top-[301px] right-[949px] left-[96px] rounded-3xl bg-whitesmoke box-border h-[444px] overflow-hidden text-left text-xl border-[2px] border-solid border-gainsboro">
      ...
      <div className="absolute w-full top-[0px] right-[0px] left-[0px] h-28 overflow-hidden">
