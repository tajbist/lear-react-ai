...
const ShoppingCart: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-xl text-black font-inter">
      <div className="absolute w-[calc(100%_-_619px)] top-[301px] right-[523px] left-[96px] rounded-3xl bg-whitesmoke box-border h-[159px] overflow-hidden border-[2px] border-solid border-gainsboro">
        ...
        <div className="absolute bottom-[24px] left-[184px] rounded-xl bg-white box-border w-32 h-10 overflow-hidden text-base border-[2px] border-solid border-gray">
        ...
        <img
          className="absolute top-[0px] left-[0px] w-40 h-[159px] object-cover"
          alt=""
          src="/tomato@2x.png"
        />
      </div>
      <div className="absolute w-[calc(100%_-_619px)] top-[491px] right-[523px] left-[96px] rounded-3xl bg-whitesmoke box-border h-[159px] overflow-hidden border-[2px] border-solid border-gainsboro">
        <div className="absolute top-[24px] left-[184px] leading-[130%] font-semibold">
          Organic ginger
        </div>
        <div className="absolute top-[54px] left-[184px] leading-[130%] font-semibold text-darkolivegreen">
      ...
      <div className="absolute w-[calc(100%_-_619px)] top-[681px] right-[523px] left-[96px] rounded-3xl bg-whitesmoke box-border h-[159px] overflow-hidden border-[2px] border-solid border-gainsboro">
        <div className="absolute top-[24px] left-[184px] leading-[130%] font-semibold">
          Sweet onion
        </div>
        <div className="absolute top-[54px] left-[184px] leading-[130%] font-semibold text-darkolivegreen">
        ...
        <img
          className="absolute top-[1px] left-[0px] w-40 h-[159px] object-cover"
          alt=""
          src="/onion@2x.png"
        />
      </div>
      <div className="absolute w-[calc(100%_-_1045px)] top-[301px] right-[96px] left-[949px] rounded-3xl bg-whitesmoke box-border h-[318px] overflow-hidden text-base border-[2px] border-solid border-gainsboro">
        ...
        <div className="absolute w-[calc(100%_-_48px)] right-[24px] bottom-[24px] left-[24px] rounded-lg bg-darkolivegreen h-12 overflow-hidden text-white">
      ...
      <div className="absolute w-full top-[112px] right-[0px] left-[0px] bg-white h-[149px] overflow-hidden">
      ...
      <div className="absolute w-full top-[0px] right-[0px] left-[0px] h-28 overflow-hidden text-center text-base">
        ...
        <div className="absolute top-[32px] right-[96px] rounded bg-darkolivegreen w-[126px] h-12 overflow-hidden text-white">
